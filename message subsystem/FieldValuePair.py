class FieldValuePair:
	...
	def Add(MessageType, FieldName, FieldValue):
		FieldValuePair.fvp = FieldValuePair(FieldName, FieldValue);
	...
	def Remove(MessageType, FieldName, FieldValue):
	...
	def Update(MessageType, FieldName, FieldValue):
